...
class AuthController(@Autowired var clientService: ClientService) {
  ...
  fun getUser(
    ...
    return RedirectView("https://login.microsoftonline.com/common/oauth2/v2.0/authorize?response_type=id_token&client_id=598471b7-0b6e-4922-a27b-6e4083046e98&scope=openid&state=W2j919NikGLy-rwsEy5Jiaw8N3U08NxcWQb4YiDjOHE%3D&response_mode=form_post&redirect_uri=http://localhost:8080/launchpad/logged/user&nonce=GBLxc1z2l1RgELLEA8UkoX98SZopOLZW_L0Q2WhmScg")
  }
